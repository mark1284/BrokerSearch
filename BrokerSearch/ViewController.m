...
// - unit tests
// - start writing a bespoke Opptracker service: OppTracker-iOS
// - externalize URL
//
...
#define searchBrokerURL @"http://lt020671:8080/OppTracker/brokerMain/searchBrokerAsJSON?includeAquila=true&query="
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([tableView isEqual:self.searchDisplayController.searchResultsTableView]){
        ...
        #ifdef DEBUG
            NSLog(@"SearchResult %@", [self.searchResults objectAtIndex:indexPath.row]);
        #endif
    }
    else{
        cell.textLabel.text =
        ...
        #ifdef DEBUG
            NSLog(@"AllResult %@", [self.allItems objectAtIndex:indexPath.row]);
        #endif
    }
...

{
    ...
    [urlStr setString :  searchBrokerURL];
...
#pragma mark use real broker objects!
